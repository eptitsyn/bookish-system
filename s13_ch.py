...
U_f = to_cpu(als_full.user_factors)
V_f = to_cpu(als_full.item_factors)
...
tr_s = val_users_warm[:n_split]
val_s = val_users_warm[n_split:]
...
feature_cols = [
    c for c in feat_val.columns if c not in IGNORE and feat_val[c].dtype.is_numeric()
]
